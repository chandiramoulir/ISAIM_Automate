## 9-July-2017: Adding logging features
...
class ISAIM_auto:
    ...
    def parse(self):
        ...
        logging.info("Loading the input excel file")
...
logging.basicConfig(filename="ISAIMLogs.log",filemode='a',level=logging.DEBUG,format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p')
